            ...
            <div className="mt-6 rounded-2xl border border-[#E7E4DC] bg-white p-4 sm:p-5">
                ...
                <div className="mt-4 flex gap-2 overflow-x-auto pb-2">
                    <button
                        ...
                        className={`shrink-0 rounded-full px-4 py-2 text-sm font-semibold transition ${category === "all"
                        ...
                        (item) => (
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    updateUrl({
                                        nextCategory: item.id,
                                    });
                                }}
                                className={`shrink-0 rounded-full px-4 py-2 text-sm font-semibold transition ${category === item.id
                                    ? "bg-[#68912B] text-white"
                                    : "border border-[#E7E4DC] bg-white text-[#1F1F1F] hover:bg-[#EDF4E4]"
                                    }`}
                            >
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                    <button
                        ...
                        className={`rounded-full px-4 py-2 text-sm font-semibold transition ${showNew
                    ...
                    <button
                        ...
                        className={`rounded-full px-4 py-2 text-sm font-semibold transition ${showHot
                            ? "bg-[#B22625] text-white"
                            : "border border-[#E7E4DC] bg-white text-[#1F1F1F] hover:bg-[#FFF3F3]"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`rounded-full px-4 py-2 text-sm font-semibold transition ${showFeatured
                            ? "bg-[#B22625] text-white"
                            : "border border-[#E7E4DC] bg-white text-[#1F1F1F] hover:bg-[#FFF3F3]"
                            }`}
                    >
