        ...
        >
          ...
          <div>
            ...
            <p className="mt-1.5 text-xs leading-5 text-gray-400">
              Leave empty to let Firestore generate
          ...
          <div>
            ...
            <textarea
              ...
              disabled={loading}
              className="w-full resize-none rounded-xl border border-[#E7E4DC] bg-white px-4 py-3 text-sm leading-6 text-[#1F1F1F] outline-none transition placeholder:text-gray-400 focus:border-[#68912B] focus:ring-2 focus:ring-[#EDF4E4] disabled:bg-gray-50"
            />
          </div>
          ...
          <div>
            ...
            <p className="mt-1.5 text-xs text-gray-400">
              ...
              Storage upload when Storage is enabled.
            </p>
          </div>
