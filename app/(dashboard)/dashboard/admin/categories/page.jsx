                                        ...
                                        {categories.map(
                                            (category) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <span
                                                            className={`inline-flex rounded-full px-3 py-1 text-xs font-semibold ${category.active
                                    ...
                                    (category) => (
                                        ...
                                        >
                                            <div className="flex items-start justify-between gap-4">
                                                ...
                                                <span
                                                    className={`shrink-0 rounded-full px-3 py-1 text-xs font-semibold ${category.active
                                                            ? "bg-[#EDF4E4] text-[#68912B]"
                                                            : "bg-gray-100 text-gray-500"
                                                        }`}
                                                >
